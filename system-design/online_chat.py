...
#         self._users_by_id = {}
#
#     def add_user(self, user_id, name, pass_hash): pass
#     def remove_user(self, user_id): pass
#     def add_friend_request(self, from_user_id, to_user_id): pass
#     def reject_friend_request(self, from_user_id, to_user_id): pass
#
# class User(object):
